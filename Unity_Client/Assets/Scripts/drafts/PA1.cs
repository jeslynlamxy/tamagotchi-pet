...
public class PostAssignmentManager : MonoBehaviour
{
    ...
    public void DisplayAddedQuestionData(int currAssimtQnIndex){
        ...
        Debug.Log("Loading currently added questions...");
    ...
    public void QnNextPage(){
        ...
        Debug.Log("Showing next page of question data...");
        Debug.Log(currQuestionIndex);
        DisplayQuestionData(currQuestionIndex); 
    }

    public void QnPrevPage(){
        // GetComponent<Button>().interactable = true;
        currQuestionIndex = currQuestionIndex - QnRows;
